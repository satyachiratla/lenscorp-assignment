export default function Vision() {
  return (
    <div className="flex flex-col items-center dark:bg-black bg-white py-20 px-4">
      ...
      <h3 className="py-10 text-2xl md:text-4xl 2xl:text-4xl md:font-medium text-center">
        AI for Social Good
      </h3>
      ...
      <div className="pt-8">
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li className="group">
            <div className="timeline-middle border-4 border-gray-300 rounded-full px-2 py-3">
              <svg
            ...
            <div className="timeline-start mb-10 space-y-5 mt-10 group-hover:scale-105 transition-all duration-300 ease-in-out md:pr-10">
              <h3 className="font-medium text-2xl">Diversity & Fairness</h3>
          ...
          <li className="group">
            ...
            <div className="timeline-end my-10 space-y-5 group-hover:scale-105 transition-all duration-300 ease-in-out md:pl-10">
              <h3 className="font-medium text-2xl">Regulatory Compliance</h3>
              <p className="text-lg text-gray-500 max-w-sm">
          ...
          <li className="group">
            ...
            <div className="timeline-start my-10 space-y-5 group-hover:scale-105 transition-all duration-300 ease-in-out md:pr-10">
              <h3 className="font-medium text-2xl">Code of Ethics</h3>
              <p className="text-lg text-gray-500 max-w-sm">
